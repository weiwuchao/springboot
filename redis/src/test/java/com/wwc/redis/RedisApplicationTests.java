package com.wwc.redis;

import com.alibaba.fastjson.JSONObject;
import com.wwc.redis.sevice.RedisService;
...
public class RedisApplicationTests {
    ...
    public void setString() {
        redisService.set("redis_test", "springboot redis test");
    }
    ...
    public void getString() {
        String result = redisService.get("redis_test");
